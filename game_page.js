...
function check()
{
	...
	if (question_turn=="player1") {
		...
		document.getElementById("player_question").innerHTML="te toca preguntar " + player2_name;
	} else {
		question_turn="player1";
		document.getElementById("player_question").innerHTML="te toca preguntar " + player1_name;
	}
	if (answer_turn=="player1") {
		answer_turn="player2";
		document.getElementById("player_answer").innerHTML="te toca responder " + player2_name;
	} else {
		answer_turn="player1";
		document.getElementById("player_answer").innerHTML="te toca responder " + player1_name;
	}
